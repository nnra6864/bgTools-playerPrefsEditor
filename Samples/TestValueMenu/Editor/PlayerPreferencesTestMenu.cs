...
namespace CCG.PlayerPrefsEditor
{
    public class PlayerPrefsTestMenu
    {
        ...
        [MenuItem("Tools/CCG-Tools/PlayerPrefs Test Values/AddEntry Strings", false, 0)]
        ...
        [MenuItem("Tools/CCG-Tools/PlayerPrefs Test Values/AddEntry Int", false, 1)]
        ...
        [MenuItem("Tools/CCG-Tools/PlayerPrefs Test Values/AddEntry Float", false, 2)]
        ...
        [MenuItem("Tools/CCG-Tools/PlayerPrefs Test Values/AddEntry ValidKeys", false, 20)]
        ...
        [MenuItem("Tools/CCG-Tools/PlayerPrefs Test Values/AddEntry Many", false, 21)]
        ...
        [MenuItem("Tools/CCG-Tools/PlayerPrefs Test Values/AddEntry Fonts", false, 22)]
        ...
        [MenuItem("Tools/CCG-Tools/PlayerPrefs Test Values/DeleteAll", false, 50)]
